  ...
  return (
    <div className="sm:mx-auto sm:w-full sm:max-w-md px-4">
      <div className="text-center mb-8">
        ...
        <h2 className="text-2xl font-bold text-slate-900 tracking-tight">Sign in to {BRAND.name}</h2>
        <p className="text-sm text-slate-500 mt-1">Manage your intelligent WhatsApp AI employees</p>
      </div>
